<script>
    import { selectedItem, listOpen } from "./store";

    /* just a clone of the default Item.svelte */
    ...
    function handleClick() {
        ...
        } else selectedItem.update(() => item);
        $listOpen = false;
    }

</script>

<div class="item {itemClasses}" on:click|stopPropagation={handleClick}>
